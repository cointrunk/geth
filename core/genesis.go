...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Timestamp:  0x62006888,
		Alloc: map[common.Address]GenesisAccount{
			params.GenesisAccountMainnet:   {Balance: new(big.Int).Mul(big.NewInt(77777777), big.NewInt(1e18))},
			...
			params.ValidatorsContractAddr:  {Balance: new(big.Int), Code: params.ValidatorsContractCodeMainnet},
			params.PunishContractAddr:      {Balance: new(big.Int), Code: params.PunishContractCodeMainnet},
		},
	}
}
...
func DefaultTestnetGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			...
			params.ValidatorsContractAddr:  {Balance: new(big.Int), Code: params.ValidatorsContractCodeTestnet},
			params.PunishContractAddr:      {Balance: new(big.Int), Code: params.PunishContractCodeTestnet},
		},
	}
}
