...
var (
	MainnetGenesisHash = common.HexToHash("0x6ed061b04b0c25591f6a49461e7322478d4af6cc8f97e5e7c39f46803f158900")
	TestnetGenesisHash = common.HexToHash("0x544514324dd426655fb693a45b3696c57d50268e9dfaee499c20f5c1193eb227")
)
...
var (
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil,
		...
		nil, nil, nil, new(EthashConfig), nil, nil}
	...
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil,
		false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0),
		big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0),
		nil, nil, nil, nil, &CliqueConfig{Period: 0, Epoch: 30000}, nil}

	// AllBposProtocolChanges copies from AllCliqueProtocolChanges.
	AllBposProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil,
		false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0),
		big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0),
		nil, nil, nil, nil, nil, &BposConfig{Period: 0, Epoch: 30000}}
...
type ChainConfig struct {
	...
	Bpos   *BposConfig   `json:"bpos,omitempty"`
}
...
// BposConfig is the consensus engine configs for proof-of-stake-authority based sealing.
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "yoloV2Block", block: c.YoloV2Block, optional: true},
	} {
		if lastFork.name != "" {
